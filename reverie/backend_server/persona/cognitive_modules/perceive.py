...
def generate_poig_score(persona, event_type, description):
  ...
  ED events are predictable enough to score by keyword matching."""
  desc_lower = description.lower()

  if "is idle" in desc_lower:
    return 1

  # High poignancy (8): major clinical events
  ...
  # Medium poignancy (5): clinical progression
  ...
  # Low poignancy (2): routine / waiting
...
def perceive(persona, maze): 
  ...
  for i in nearby_tiles: 
    ...
    if i["sector"]: 
      if i["world"] == "":
        print("Empty 'world' value at coordinate:", coord)
    ...
    if i["arena"]: 
      if i["world"] == "":
        print("Empty 'world' value at coordinate:", coord)
      if i["sector"] == "":
        print("Empty 'sector' value at coordinate:", coord)
    ...
    if i["game_object"]:
      ...
      if i["sector"] == "":
        print("Empty 'sector' value at coordinate:", coord)
      if i["arena"] == "":
        print("Empty 'arena' value at coordinate:", coord)
  ...
  for p_event in perceived_events: 
    ...
    if ((p_event not in latest_events) or 
        (p_event[0] in str(persona.scratch.next_step) and persona.scratch.chatting_with == None)):
